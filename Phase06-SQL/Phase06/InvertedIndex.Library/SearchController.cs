...
namespace InvertedIndex.Library
{
    public class SearchController
    {
        ...
        WordsDatabaseController wordsController;
        FilesDatabaseController filesController;

        public SearchController(FilesDatabaseController controller, string path)
        {
            this.filesController = controller;
            filesController.ReadAllFiles(path);
            this.wordsController = new WordsDatabaseController(this.filesController);
        }
        ...
        private List<string> FindDocsOfSearchWords(List<string> noSignWords, List<string> plusSignWords, List<string> minusSignWords)
        {
        ...
        private List<string> FindFinalDocs(List<string> noSignWordsDocs, List<string> plusSignWordsDocs, List<string> minusSignWordsDocs, List<string> minusSignWords)
        {
            List<string> signWordsDocs = new List<string>(FindFinalDocsOfSignWords(plusSignWordsDocs, minusSignWordsDocs, minusSignWords));
        ...
        private List<string> FindFinalDocsOfSignWords(List<string> plusSignWordsDocs, List<string> minusSignWordsDocs, List<string> minusSignWords)
        {
            List<string> docs = new List<string>();
